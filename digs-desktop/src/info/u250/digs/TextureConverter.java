...
public class TextureConverter {
	...
	public static Array<Array<Vector2>> createPolygon(int[] data, int width,
			int height, float hullTolerance, byte alphaTolerance,
...
class PolygonCreationAssistance {
	...
	private int _alphaToleranceRealValue;
	...
	public void setAlphaTolerance(byte value) {
		_alphaTolerance = value;
		_alphaToleranceRealValue = (int) value << 24;
	}
